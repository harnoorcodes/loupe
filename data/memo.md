...
6 confirmed findings: 1 critical, 1 high, 3 medium, 1 low. 2 of these required evidence from more than one document.

1 finding(s) carry a quantified impact totalling approximately USD 2,058,824. The remainder could not be quantified from the evidence available and are reported qualitatively.
...
### 1. Customer with Change of Control termination represents 43% of total revenue
...
### 2. Stated share total does not reconcile with identified holdings
...
**Estimated impact:** USD 2,058,824
...
### 3. Missing: Shareholders Agreement
...
### 4. Missing: Equity incentive plan document
...
### 5. Missing: Tax returns for the last three years
...
Monetary estimates are derived only from figures appearing in the cited evidence. Findings that could not be quantified from the evidence are reported without a figure rather than estimated.
